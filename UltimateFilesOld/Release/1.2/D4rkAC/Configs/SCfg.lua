ConfigServer = {
    ...
    AcePermission = "D4rkAC", -- Do not touch if you don't know what is it (Only use if you need in special cases)

    PermissionGroups = {"mod", "admin", "superadmin"}, -- Groups that can use the AntiCheat Menu and don't get banned

    BanReload = "60", -- Time in seconds that that the Banlist would reload

    CrashOnBan = false, -- If the AntiCheat should kick or crash the player when he gets banned
